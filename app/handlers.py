...
🔹 /start – Начать
Эта команда запускает бота и отправляет приветственное сообщение. Ты узнаешь, чем может помочь бот, и получишь доступ к основному меню.
...
🔹 /post – Создать пост
Позволяет создать текстовый пост для Telegram-канала. Бот предложит вам написать описание, сгенерирует текст, а затем ты сможешь либо утвердить его, либо попросить переделать.

💡 Обрати внимание! Внизу слева есть кнопка "Меню", где можно быстро выбрать нужную команду. 🚀""")
